...
// shared role labels used by route meta checks
const ROLE = {
  Admin: "Admin",
...
// route groups are split by public customer specialist and admin areas
const routes = [
  {
    path: "/",
    redirect: "/login",
  },
  {
    ...
    children: [
      ...
      {
        path: "expert-admin-login",
        name: "expert-admin-login",
        component: ExpertAdminLoginPage,
      },
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "specialists",
        name: "customer.specialists",
        component: CustomerSpecialistsPage,
      },
      {
        path: "specialists/:id",
        name: "customer.specialistDetail",
        component: CustomerSpecialistDetailPage,
        props: true,
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: SpecialistSchedulePage,
      },
      {
        path: "requests",
      ...
      {
        path: "bookings/:id",
        name: "specialist.bookingDetail",
        component: SpecialistBookingDetailPage,
        props: true,
      },
      {
        path: "slots",
        name: "specialist.slots",
        component: SpecialistSlotsPage,
      },
      {
        path: "slots/create",
        name: "specialist.slotCreate",
        component: SpecialistSlotCreatePage,
      },
      {
        path: "slots/:id/edit",
        name: "specialist.slotEdit",
        component: SpecialistSlotCreatePage,
        props: true,
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: AdminSpecialistsPage,
      },
      {
        path: "expertise",
        name: "admin.expertise",
        component: AdminExpertisePage,
      },
      { path: "slots", name: "admin.slots", component: AdminSlotsPage },
      {
        path: "slots/create",
        name: "admin.slotCreate",
        component: AdminSlotCreatePage,
      },
      { path: "pricing", name: "admin.pricing", component: AdminPricingPage },
      {
        path: "pricing/create",
        name: "admin.pricingCreate",
        component: AdminPricingRuleCreatePage,
      },
      {
        path: "bookings",
        name: "admin.bookings",
...
// global guard handles auth, login redirect, and role access
